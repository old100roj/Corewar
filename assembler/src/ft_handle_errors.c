...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/30 20:14:01 by iganich           #+#    #+#             */
/*   Updated: 2019/01/30 20:14:02 by iganich          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**make_errors(char **errors)
{
	...
	errors[24] = "WRONG NAME LENGTH";
	errors[25] = "WRONG COMMENT LENGTH";
	return (errors);
}
...
void	ft_handle_errors(t_error *error, t_argument ***arguments)
{
	...
	errors = (char **)malloc(sizeof(char *) * 26);
